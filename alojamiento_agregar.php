...
<body>
    ...
    <form method="post" action="alojamiento_accion_agregar.php">
        <div class="flex py-4 items-center justify-center bg-orange-50">
            <div class="w-96 p-6 shadow-lg bg-white rounded-md">
                <h1 class="text-2xl block text-center font-semibold">AGREGAR RESERVA ALOJAMIENTO</h1>
                <hr class="mt-3" />
                <div class="mt-3">
                ...
                <div class="mt-3">
                    <label class="block text-base mb-2 font-bold">Ciudad</label>
                    <input type="text" name="Ciudad" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Ingrese el ciudad destino..." required />
                </div>
                <div class="mt-3">
                    <label class="block text-base mb-2 font-bold">Hotel</label>
                    <input type="text" name="Hotel" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" placeholder="Indique nombre hotel sugerido..." required />
                </div>
                <div class="mt-3">
                    <label class="block text-base mb-2 font-bold">Fecha Entrada</label>
                    <input type="date" name="FechaEntrada" class="border w-full text-base px-2 py-1 focus:outline-none focus:ring-0 focus:border-gray-600" required />
                </div>
                <div class="mt-3">
